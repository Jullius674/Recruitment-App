import { Bell, Search, User, Briefcase } from "lucide-react@0.487.0";
        ...
        <div className="px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-8">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-slate-900">TalentAI</span>
            </div>
          </div>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="gap-2">
                  ...
                  <span className="text-slate-700">Jane Doe</span>
                </Button>
              </DropdownMenuTrigger>
